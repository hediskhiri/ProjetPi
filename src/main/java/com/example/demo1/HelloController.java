...
//
    ...
    public boolean isAdminEmail(String email) {
        ...
        String emailAdministrateur = "rawef31@gmail.com";
    ...
    public void sendResetEmail(String recipientEmail, String randomPassword) {
        ...
        String username = "bike.esprit@gmail.com"; // Adresse e-mail de l'expéditeur
        String password = "zkhd ivmz qysp tuwi"; // Mot de passe de l'expéditeur
